...
function StarField() {
  ...
  useEffect(() => {
    ...
    draw()
    return () => { cancelAnimationFrame(animId); window.removeEventListener('resize', resize); window.removeEventListener('mousemove', null) }
  }, [])
      ...
      <header className="fixed top-0 w-full z-50 bg-[#030712]/70 backdrop-blur-xl border-b border-violet-500/10 shadow-[0_4px_30px_rgba(0,0,0,0.3)]">
        <nav className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto font-['Space_Grotesk'] tracking-tight">
          ...
          <div className="hidden md:flex items-center gap-gutter">
            <a className="text-slate-400 font-medium hover:text-violet-300 hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.6)] transition-all duration-300" href="#about">About</a>
            <a className="text-slate-400 font-medium hover:text-violet-300 hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.6)] transition-all duration-300" href="#skills">Skills</a>
            <a className="text-slate-400 font-medium hover:text-violet-300 hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.6)] transition-all duration-300" href="#projects">Projects</a>
            <a className="text-slate-400 font-medium hover:text-violet-300 hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.6)] transition-all duration-300" href="#leadership">Leadership</a>
            <a className="text-slate-400 font-medium hover:text-violet-300 hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.6)] transition-all duration-300" href="#contact">Contact</a>
          </div>
        ...
        <section className="min-h-screen flex flex-col justify-center items-center text-center pt-20 relative overflow-hidden" id="hero">
          ...
          <div className="space-y-8 relative z-20 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-10">
              <a className="btn-magnetic px-12 py-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-full font-label-caps text-white shadow-[0_0_40px_rgba(139,92,246,0.6)] transition-transform hover:-translate-y-2 hover:scale-105 tracking-[0.2em] text-xs font-bold" href="#projects">
                VIEW WORK
              </a>
              <a className="btn-magnetic px-12 py-5 border border-violet-500/40 rounded-full font-label-caps text-violet-300 hover:bg-violet-500/20 hover:border-violet-400 hover:shadow-[0_0_30px_rgba(139,92,246,0.3)] transition-all transform hover:-translate-y-1 tracking-[0.2em] text-xs font-bold backdrop-blur-sm" href="#contact">
                CONNECT
              </a>
            </div>
          </div>
